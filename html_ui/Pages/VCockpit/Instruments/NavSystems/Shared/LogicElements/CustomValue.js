    ...
    Update() {
        ...
        switch (this.valueIndex) {
            ...
            case 6:
                ...
                var ETA = SimVar.GetSimVarValue("GPS WP ETA", "seconds");
                this.valueDisplay.textContent = !flightPlanActive ? "__:__" : Math.floor(ETA / 60) + ":" + ETA % 60;
                break;
            case 7:
                this.nameDisplay.textContent = "ETE";
                this.unitDisplay.innerHTML = "";
                var ETE = SimVar.GetSimVarValue("GPS WP ETE", "seconds");
                this.valueDisplay.textContent = !flightPlanActive ? "__:__" : Math.floor(ETE / 60) + ":" + ETE % 60;
                break;
            case 8:
