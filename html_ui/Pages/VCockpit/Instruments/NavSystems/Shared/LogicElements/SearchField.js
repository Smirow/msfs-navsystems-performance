    ...
    Update() {
        ...
        if (this.isActive) {
            ...
            if (this.lastIcao != relatedIcao) {
                this.relatedIcaoSearch.SetWaypoint(SimVar.GetSimVarValue("C:fs9gps:NameSearchCurrentIcaoType", "string", this.instrument.instrumentIdentifier), SimVar.GetSimVarValue("C:fs9gps:NameSearchCurrentIcao", "string", this.instrument.instrumentIdentifier));
            }
        }
        else {
            if (this.isActive) {
